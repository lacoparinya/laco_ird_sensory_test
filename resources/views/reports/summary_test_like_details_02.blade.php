 ...
 <script type="text/javascript">
     ...
     function drawChart6() {
         ...
         var options = {
             legend: 'none',
             pieSliceText: 'label',
             title: 'ผลิตภัณฑ์ {{ $quizM->name }} : {{ $quizM->questionType->name }} Sweet',
             pieStartAngle: 100,
         };
     ...
     function drawChart7() {
         ...
         var options = {
             legend: 'none',
             pieSliceText: 'label',
             title: 'ผลิตภัณฑ์ {{ $quizM->name }} : {{ $quizM->questionType->name }} Volume',
             pieStartAngle: 100,
         };
